...
fileConn<-file(paste0("datasets/fasttext_sentence_embeddings/", fileName,"-train.txt"), 'w')
...
fileConn<-file(paste0("datasets/fasttext_sentence_embeddings/", fileName,"-C1.txt"), 'w')
...
fileConn<-file(paste0("datasets/fasttext_sentence_embeddings/", fileName,"-C2.txt"), 'w')
